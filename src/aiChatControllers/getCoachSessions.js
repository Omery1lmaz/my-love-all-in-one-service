...
exports.getCoachSessions = void 0;
const aiChat_1 = require("../Models/aiChat");
const aiClient_1 = require("../utils/aiClient");
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const user_1 = require("../Models/user");
const mongoose_1 = __importDefault(require("mongoose"));
const getCoachSessions = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const sessions = yield aiChat_1.AIChatSession.find({
            userId: user._id,
            coachId,
            isActive: true
        })
