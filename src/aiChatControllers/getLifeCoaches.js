...
exports.getLifeCoaches = void 0;
const aiClient_1 = require("../utils/aiClient");
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const user_1 = require("../Models/user");
const mongoose_1 = __importDefault(require("mongoose"));
const getLifeCoaches = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const coaches = (0, aiClient_1.getAvailableLifeCoaches)();
        res.status(200).json({
            success: true,
            data: coaches,
        });
...
exports.getLifeCoaches = getLifeCoaches;
