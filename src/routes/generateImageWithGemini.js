...
exports.generateImageWithGeminiRouter = void 0;
const express_1 = __importDefault(require("express"));
const aiClient_1 = require("../utils/aiClient");
const router = express_1.default.Router();
exports.generateImageWithGeminiRouter = router;
router.post("/api/ai/gemini-image", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (() => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const result = yield (0, aiClient_1.generateImageWithGemini)({
                prompt,
                n: n ? parseInt(n) : 1,
            });
