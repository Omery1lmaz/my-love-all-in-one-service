...
import { generateImageWithStableDiffusion } from "../utils/aiClient";

const router = express.Router();

router.post("/api/ai/stable-diffusion", async (req, res) => {
  (async () => {
    try {
...
export { router as generateImageWithStableDiffusionRouter }; 