...
exports.getTimeLineById = void 0;
const common_1 = require("@heaven-nsoft/common");
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const timeline_1 = require("../Models/timeline");
const getTimeLineById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        const timelines = yield timeline_1.Timeline.findOne({
...
exports.default = exports.getTimeLineById;
