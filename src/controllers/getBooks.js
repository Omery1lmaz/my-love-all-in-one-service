...
const getBooksController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        try {
            ...
            if (partner) {
                books.partner = ((_a = partner.books) === null || _a === void 0 ? void 0 : _a.filter((hobby) => hobby.sharedWithPartner)) || [];
            }
            res
                .status(200)
