...
exports.updateQuestionScoreController = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const user_1 = require("../Models/user");
const common_1 = require("@heaven-nsoft/common");
const mongoose_1 = __importDefault(require("mongoose"));
const updateQuestionScoreController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!user.questions) {
            next(new common_1.BadRequestError("User has not any question"));
            return;
        }
        const questionIndex = user.questions.findIndex((question) => {
        ...
        res.status(200).json({
            ...
            status: "success",
            statusCode: 200,
            data: (user === null || user === void 0 ? void 0 : user.questions) || [],
        });
    }
    catch (error) {
...
exports.updateQuestionScoreController = updateQuestionScoreController;
exports.default = exports.updateQuestionScoreController;
