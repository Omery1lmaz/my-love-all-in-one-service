...
exports.updateHobbyController = void 0;
const user_1 = require("../Models/user");
const common_1 = require("@heaven-nsoft/common");
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const updateHobbyController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.updateHobbyController = updateHobbyController;
