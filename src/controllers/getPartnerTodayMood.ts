...
const getPartnerTodayMoodController = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const todayMood = partner.moodHistory?.find((mood) => {
...
export default getPartnerTodayMoodController;
