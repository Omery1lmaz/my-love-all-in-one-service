...
const getTodayMoodController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        const todayMood = (_a = user.moodHistory) === null || _a === void 0 ? void 0 : _a.find((mood) => {
...
exports.default = getTodayMoodController;
