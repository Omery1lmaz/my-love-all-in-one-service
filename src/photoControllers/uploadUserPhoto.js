...
exports.uploadUserPhotoController = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const common_1 = require("@heaven-nsoft/common");
const sharp_1 = __importDefault(require("sharp"));
const userPhoto_1 = require("../Models/userPhoto");
const upload_1 = require("../utils/upload");
const uploadUserPhotoController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        try {
...
exports.uploadUserPhotoController = uploadUserPhotoController;
exports.default = exports.uploadUserPhotoController;
