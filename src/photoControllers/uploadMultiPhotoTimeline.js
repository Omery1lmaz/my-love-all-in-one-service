...
const uploadMultiPhotoTimelineController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { description = "", tags = [], musicUrl = "", note = "", location, coverPhotoFileName, timelineId, } = req.body;
        ...
        const timeline = yield timeline_1.Timeline.findById(timelineId);
        if (!timeline) {
            console.log("timeline not found");
            next(new common_1.NotFoundError());
            return;
        }
        timeline.photos = uploadedPhotos.map((photo) => photo._id);
        yield timeline.save();
...
exports.default = uploadMultiPhotoTimelineController;
